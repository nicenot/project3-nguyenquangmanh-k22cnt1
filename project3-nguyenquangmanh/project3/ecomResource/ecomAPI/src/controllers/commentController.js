...
let getAllComment = async (req, res) => {
    try {
        ...
        let data = await commentService.getAllComment(req.body);
        return res.status(200).json(data);
    } catch (error) {
        console.log(error)
        return res.status(200).json({
...
let deleteCommentByCommentId = async (req, res) => {
    try {
        
        let data = await commentService.deleteCommentByCommentId(req.query.id);
        return res.status(200).json(data);
    } catch (error) {
        console.log(error)
        return res.status(200).json({
