    ...
    return (
        <div className="voucher-container">
            <div className="voucher-banner">
                ...
                <img className="banner-today" src={voucherTodayPhoto}></img>
            ...
            <div className="voucher-list">
                {dataVoucher && dataVoucher.length > 0 &&
                    dataVoucher.map((item, index) => {
                        ...
                        return (
                            <VoucherItem sendDataFromVoucherItem={sendDataFromVoucherItem} id={item.id} key={index} name={item.codeVoucher} widthPercent={item.usedAmount * 100 / item.amount} maxValue={MaxValue} usedAmount={Math.round((item.usedAmount * 100 / item.amount) * 10) / 10} typeVoucher={percent} />
                        )
                    })
                }
